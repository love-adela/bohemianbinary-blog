...
urlpatterns = [
    ...
    path('post/<uuid:post_id>/edit/', views.PostUpdateView.as_view(), name='post_edit'),
    path('post/<uuid:post_id>/publish/', views.PostPublishRedriectView.as_view(), name='post_publish'),
    path('post/<uuid:post_id>/remove/', views.PostRemoveRedirectView.as_view(), name='post_remove'),
    path('post/<uuid:post_id>/comment/', views.CommentCreateView.as_view(), name='add_comment_to_post'),
    path('post/<uuid:post_id>/revision/', views.RevisionIndexView.as_view(), name='revision_list'),
    path('post/<uuid:post_id>/revisions/<int:revision_id>', views.RevisionDetailView.as_view(), name='revision_detail'), 
